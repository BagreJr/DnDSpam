    ...
    const classes = [
        ...
        { name: "Artificer", hitDie: 'd8', savingThrows: ['CON', 'INT'], image: "images/artificer.webp", description: "Maestros de la magia y la tecnología, que crean artefactos mágicos y construcciones complejas.", link: "https://homebrewery.naturalcrit.com/share/XlnxbXPJwSb_", subclasses: ["Aeronaut", "Agent", "Alchemist", "Archivist", "Armorer", "Augmenter", "Battle Smith", "Biomancer","Cartographer", "Chronothief", "Composer", "Cryptozoologist", "Dungeoneer", "Enhanced", "Forgewright", "Machinist", "Mechanic","Miner","Nuclear Engineer", "Pilot", "Prosthetist", "Puppeteer", "Reanimator", "Venomist", "Wandslinger"] },
        { name: "Barbarian", hitDie: 'd12', savingThrows: ['STR', 'CON'], image: "images/barbarian.webp", description: "Guerreros primitivos que canalizan su furia en combate, capaces de resistir grandes daños y desatar su fuerza bruta.", link: "https://homebrewery.naturalcrit.com/share/EMNC8JdcJ-I1", subclasses: ["Path of the Ancestral Guardian", "Path of the Battlerager", "Path of the Beast", "Path of the Berserker", "Path of the Brute", "Path of the Burning Rage", "Path of the Champion", "Path of the Deep", "Path of the Devourer", "Path of the Dreadnought", "Path of the Drifter", "Path of the Favored", "Path of the Fin", "Path of the Gilded Horn","Path of the Glaicer", "Path of the Kaiju", "Path of Heavy Metal", "Path of the Infernal","Path of the Inferno", "Path of the Juggernaut", "Path of the Muscle Wizard", "Path of the Lycan", "Path of the Mutant", "Path of the Reaver", "Path of the Storm Herald", "Path of the Titan", "Path of the Totem Warrior", "Path of Tranquility", "Path of the Warden", "Path of the Wrecker", "Path of Wilds","Path of Wild Magic", "Path of the World Tree", "Path of the Zealot"] },
        { name: "Bard", hitDie: 'd8', savingThrows: ['DEX', 'CHA'], image: "images/bard.webp", description: "Músicos encantadores y maestros de la magia, cuya música inspira y controla la magia.", link: "https://homebrewery.naturalcrit.com/share/nqImfN7DQmo8", subclasses: ["College of Apocalyps","College of Birdsong", "College of Blade Conductors", "College of Cantors", "College of Chance", "College of Chaos", "College of Command", "College of Creation", "College of Crossroads", "College of Cyberwave", "College of Dance", "College of Drama", "College of Eloquence", "College of Eulogies", "College of Fey", "College of Fine Art", "College of Fools", "College of Glamour", "College of Glory", "College of Graffiti", "College of Jesters", "College of Lore", "College of the Mad God", "College of Many Faces", "College of Masks", "College of Mercantile","College of Radiance", "College of Revelry", "College of Romance", "College of the Spheres", "College of Swords", "College of Thunder","College of the Vanguard", "College of Valor", "College of Whispers", "College of the Wilds"] },
        ...
        { name: "Magus", hitDie: 'd10', savingThrows: ['CON', 'INT'], image: "images/magus.webp", description: "Talentoso en el uso de magia mediante el dominio de espadas y hechizos combinados.", link: "https://homebrewery.naturalcrit.com/share/ghElGwEE2Io9", subclasses: ["Order of Aether Blade","Order of Arcanists", "Order of Arcane Archers", "Order of Armorers", "Order of the Aurora", "Order of Blades", "Order of Blade Dancers", "Order of Conduits", "Order of Evolution", "Order of Hexblades", "Order of the Occultism", "Order of Scales", "Order of Serpent Bearer","Order of Spellswords", "Order of Sentinels", "Order of Spellbreakers", "Order of Travelers"] },
        { name: "Martyr", hitDie: 'd12', savingThrows: ['STR', 'WIS'], image: "images/martyr.webp", description: "Héroe que sacrifica su propio bienestar por el bien de los demás, con un fuerte sentido del sacrificio y la redención.", link: "https://homebrewery.naturalcrit.com/share/o8FUKqZUgoT7", subclasses: ["Burden of Anonymity", "Burden of Ascension", "Burden of Atonement", "Burden of Awakening","Burden of Calamity", "Burden of Discord", "Burden of the End", "Burden of the Equinox","Burden of Fame", "Burden of Humanity", "Burden of Judgment","Burden of Levity", "Burden of Primarch","Burden of Mercy", "Burden of Rebirth", "Burden of Revolution", "Burden of Truth", "Burden of Tyranny", "Burden of Uncharted"] },
        { name: "Monk", hitDie: 'd8', savingThrows: ['STR', 'DEX'], image: "images/monk.webp", description: "Experto en artes marciales y en la meditación, que canaliza su energía interior para mejorar sus habilidades físicas y espirituales.", link: "https://homebrewery.naturalcrit.com/share/guTke3mXD9Nk", subclasses: ["Way of the Astral Self", "Way of the Ascendant Dragon", "Way of the Boulder", "Way of the Bow", "Way of the Brawler", "Way of the Butterfly", "Way of the Dodo", "Way of the Drunken Fist", "Way of the Eight Gates", "Way of the Eldirtch Soul","Way of the Feather", "Way of Ferocity", "Way of the Flagellant", "Way of the Flowing River", "Way of the Four Fists", "Way of Gravity", "Way of the Hurricane", "Way of the Mask", "Way of the Open Hand", "Way of Radiance", "Way of the Reaper", "Way of the Riftwalker","Way of the Sacred Inks", "Way of the Shadow Arts", "Way of Street Fighting", "Way of the Vigilante", "Way of the Void", "Way of the Warped", "Way of the Wu Jen", "Way of the Wuxia"] },
        { name: "Necromancer", hitDie: 'd6', savingThrows: ['INT', 'CON'], image: "images/necromancer.webp", description: "Ente que manipula las fuerzas de la muerte y controla a los muertos para servir a sus fines oscuros.", link: "https://homebrewery.naturalcrit.com/share/yrujLNR8NHGX", subclasses: ["Black Rider", "Blood Ascendent", "Bonefist","Bow of the Grave", "Corpse Florist", "Crone", "Cyberghoul","Divine Soul", "Dead Mist Acolyte", "Death Knight", "Harbinger of Darkness", "Necrodancer", "Overlord", "Pale Master", "Pharaoh", "Plague Lord", "Reanimator", "Reaper", "Spectral Bomber","Toymaker"] },
        { name: "Paladin", hitDie: 'd10', savingThrows: ['WIS', 'CHA'], image: "images/paladin.webp", description: "Caballero sagrado que combate el mal con el poder divino y un fuerte código de honor.", link: "https://homebrewery.naturalcrit.com/share/QL_7_qGcSaio", subclasses: ["Oath of the Ancients", "Oath of Avarice","Oath of Beauty", "Oath of the Blade", "Oath of the Bound", "Oath of Conquest", "Oath of the Corsair","Oath of the Crown", "Oath of Devotion", "Oath of the Doomforged","Oath of the Eldritch Hunt","Oath of the Eternal Dragon", "Oath of Eternal Night", "Oath of the Exorcist", "Oath of the Flash","Oath of the Forge", "Oath of the Friendship", "Oath of the Gamma Knight","Oath of the Gilded Lion","Oath of Glory", "Oath of Heresy", "Oath of Inquisition", "Oath of Judgement","Oath of Liberty", "Oath of Neversetting Star", "Oath of the Noble Genies","Oath of Mysticism", "Oath of Preservation", "Oath of Prosperity", "Oath of Redemption", "Oath of Revelry", "Oath of the Sanity", "Oath of the Shield", "Oath of Silence","Oath of Speed","Oath of Solar","Oath of Storms", "Oath of the Sun", "Oath of Timekeeper","Oath of Vengeance", "Oath of the Watchers", "Oath of Winter", "Oath of the Yojimbo", "The Oathless", "Oathbreaker"] },
        { name: "Psionico", hitDie: 'd6', savingThrows: ['WIS', 'INT'], image: "images/psion.webp", description: "La realidad se desvía hacia donde van tus pensamientos. Los psiónicos canalizan la voluntad pura, transformando el pensamiento, la emoción y la memoria en fuerza psíquica pura.", link: "https://homebrewery.naturalcrit.com/share/MoGx_lZZ32mC", subclasses: ["Awakened Mind", "Consuming Mind", "Elemental Mind", "Knowing Mind","Resonant Mind","Shaper’s Mind", "Transcended Mind", "Unleashed Mind","Wandering Mind","Warped Mind"] },
        { name: "Ranger", hitDie: 'd10', savingThrows: ['STR', 'DEX'], image: "images/ranger.webp", description: "Explorador experto en el uso de arcos y el sigilo, con un vínculo profundo con la naturaleza.", link: "https://homebrewery.naturalcrit.com/share/usNwevklFcoN", subclasses: ["Beastborne", "Beast Master", "Bounty Hunter", "Buccaneer", "Crystal Guardian","Deadeye Sniper", "Death Hunter","Drakewarden", "Druidic Guardian", "Dunestrider", "Fey Wanderer", "Freerunner", "Gloom Stalker", "Grim Warden", "Horizon Walker", "Highwayman", "Hunter", "Monster Slayer", "Ninth House Guardian", "Nomad", "Reconnaissance Scout", "Ronin", "Skysworn", "Slim Rancher","Shadowbane", "Spiritbound", "Spellbreaker", "Stargazer", "Stormchaser","Swarmkeeper","Torturer Conclave","Trapper", "Vigilante", "Wrangler"] },
        { name: "Rogue", hitDie: 'd8', savingThrows: ['DEX', 'INT'], image: "images/rogue.webp", description: "Experto en el sigilo, la evasión y las trampas, ideal para misiones que requieren astucia y agilidad.", link: "https://homebrewery.naturalcrit.com/share/TQg2QgZKbsDv", subclasses: ["Arachnoid Stalker", "Arcane Trickster", "Angler", "Assassin", "Bloodknife", "Chameleon", "Charlatan", "Cyberninja", "Darkkness Knight","Duskcaller", "Enforcer", "Daredevil", "Duelist", "Falconer", "Gambler", "Gatekeeper of the Grave","Gloaming Knight","Grifter", "Infiltrator", "Inquisitive", "Jumper", "Justicar", "Magehunter", "Mastermind", "Phantom", "Ruffian", "Saboteur", "Scion of the Three","Scoundrel", "Scout", "Socialite", "Soulknife", "Shadow Master", "Skinchanger", "Steelsilk Operative","Surgeon", "Swashbuckler", "Tamaya", "Temporal Trickster", "Thief", "Titan Slayer","Windwalker"] },
        { name: "Savant", hitDie: 'd8', savingThrows: ['INT', 'WIS'], image: "images/savant.webp", description: "Conocedor profundo de las artes arcanas o la ciencia, con habilidades excepcionales para el estudio y la enseñanza.", link: "https://homebrewery.naturalcrit.com/share/3Lw7KbWJnUsy", subclasses: ["Adeptus Administratum", "Archaeologist", "Culinarian", "Engineer", "Gunner","Investigator", "Naturalist", "Mentors", "Occultist", "Orator", "Philosopher", "Physician", "Rune Scribe", "Tactician", "Tinker", "Virtuoso", "Voyager"] },
        ...
        { name: "Sorcerer", hitDie: 'd6', savingThrows: ['CON', 'CHA'], image: "images/sorcerer.webp", description: "Un hechicero que canaliza su magia a través de su linaje o conexión con fuerzas sobrenaturales.", link: "https://homebrewery.naturalcrit.com/share/NOEmC8CLMj9P", subclasses: ["Aberrant Mind", "Aether Heart","Astral Sorcery","Bloodrazor","The Chained", "Clockwork Soul", "Cosmic Sorcery", "Dark Wild Magic","Divine Soul", "Divine Right", "Draconic Bloodline", "Emberheart", "Emotion Lord", "Faeblood", "Frost Sorcery", "Gifted One", "Greensinger", "Hellspawn", "Iron Sorcery","Jinx", "Lunar Sorcery", "Magnetism Sorcery", "Mirrorkin", "Mutagenic Bloodline", "Nanite Host", "Oozemaster", "Radiation Freak", "Reincarnated Hero", "Shadow", "Spiritborn", "Spirit Caller", "Starlight Sorcery","Stoneblood", "Storm Sorcery", "Toon Magic", "Vampiric Soul", "Voidwielder", "Waveborn", "Wild Magic"] },
        { name: "Vagabond", hitDie: 'd10', savingThrows: ['STR', 'CON'], image: "images/vagabond.webp", description: "Exiliados, perseguidos o simplemente inquietos que viven en movimiento. El camino es su hogar y la desesperación, su mayor maestra.", link: "https://homebrewery.naturalcrit.com/share/7LePIfQ0CLhu", subclasses: ["Adrenaline Junkie", "Brigand", "Experiment X", "Feylost", "Gourmand","Heretic" ,"Houndmaster","Jaeger","Justicar","Knight Errant","Mage Brand","Marauder","Mindblade","Plague Doctor","Pugilist","Rōnin","Sanguine Chapter","Troubadour", "Way of the Twelfth House"] },
        { name: "Vessel", hitDie: 'd10', savingThrows: ['CON', 'CHA'], image: "images/vessel.webp", description: "Un ser marcado por una conexión especial con espíritus, otorgándole poderes místicos y transformadores.", link: "https://homebrewery.naturalcrit.com/share/vBYpvFeHFy6v", subclasses: ["The Ancient Wyrms", "The Ascended", "The Beyond", "The Cataclysm", "The Cursed", "The Darkslayer","The Departed","The Disgraced","The Fallen", "The Formless", "The Legendary Bloodline","The Mushroom Prince", "The Mythic Hero", "The Parasite", "The Overgrown", "The Titan", "The Trickster", "The Undying"] },
        { name: "Warden", hitDie: 'd12', savingThrows: ['CON', 'STR'], image: "images/warden.webp", description: "Defensores de tierras y territorios, especializados en la protección de lo que es sagrado o valioso.", link: "https://homebrewery.naturalcrit.com/share/90VpGRQPU-Cn", subclasses: ["Beastblood Guardian", "Carrion King", "The Celestial Ram","Cosmic Seeker","Elastic Hero","Eye of Twilight", "Diabolist","Drake Blooded","Fey Trailblazer", "Godsworn", "Gravitational Bastion","Grey Watchman", "Gunbreaker","Hellkeeper", "Iceheart Bastion", "Lawbringer", "Loreseeker", "Nightgaunt", "Soulblood Shaman", "Steel Shepherd","Stoneheart Defender", "Storm Sentinel", "Sun Watcher", "Timetwister","Titanblood Sentinel", "Verdant Protector", "Wind Keeper", "Witchbane Hunter"] },
        { name: "Warlock", hitDie: 'd8', savingThrows: ['WIS', 'CHA'],  image: "images/warlock.webp", description: "Ser que obtiene poder mediante pactos con entidades sobrenaturales a cambio de favores y lealtad.", link: "https://homebrewery.naturalcrit.com/share/kLwQFqpQ7pei", subclasses: ["The Alabaster", "The Archfey", "The Archmage", "The Celestial", "The Coven", "The Dead Mists", "The Elder Sphinx", "The Fathomless", "The Fiend", "The Future You", "The Genie", "The GM", "The Great Tree","The Great Old One", "The Great Wyrm", "The Hexblade", "The King", "The Lantern","The Legacy", "The Legendary Hero", "The Magician", "The Mummy Lord", "The Primeval Growth", "Raven Queen","The Shinigami", "The Singularity", "The Solar", "The Star", "The Swarm", "The Symbiont", "The Titan", "The Unblinking", "The Undead", "The Undying","The Virtuoso","The Void", "The Wild Hunt"] },
        { name: "Warlord", hitDie: 'd10', savingThrows: ['INT', 'CON'], image: "images/warlord.webp", description: "Señor de la guerra, un líder militar que dirige a sus tropas con astucia y habilidad estratégica en el campo de batalla.", link: "https://homebrewery.naturalcrit.com/share/3IUIglJ_K-O4", subclasses: ["Academy of Chivalry", "Academy of Claws","Academy of Counsel","Academy of Dawnbringer", "Academy of Dreadlords", "Academy of Ferocity", "Academy of Liberty","Academy of Order","Academy of the Red","Academy of the Seadog","Academy of Schemes", "Academy of the Sixth Firmament","Academy of Skalds", "Academy of Tactics","Academy of Zeals"] },
        ...
        { name: "Wizard", hitDie: 'd6', savingThrows: ['INT', 'WIS'], image: "images/wizard.webp", description: "Erudito en el estudio y dominio de la magia arcana, capaz de lanzar poderosos hechizos y controlarla con precisión.", link: "https://homebrewery.naturalcrit.com/share/ymEiMM7-iT9H", subclasses: ["Familiar Master", "Magic Missile Mage", "Mystic Savant", "Order of Embalmers", "Order of Scribes", "Origami Mage","School of Abjuration", "School of Animism","School of Automata", "School of Bladesinging", "School of Conjuration", "School of Chronomancy", "School of Divination", "School of Enchantment", "School of Evocation", "School of Gastronomy", "School of Graviturgy", "School of Hardlight", "School of Hexcraft", "School of Illusion", "School of Necromancy", "School of Metallurgy", "School of Onomancy","School of Somnomancy", "School of Theurgy", "School of Teleportation", "School of Transmutation", "School of War Magic", "School of Warp Watcher", "Shinobi"] },
...
document.addEventListener("DOMContentLoaded", () => {
 ...
 // --- NEW HP CALCULATOR VARIABLES ---
    ...
    button.addEventListener("click", () => {
        ...
        subclassTierListButton.disabled = true;
        subclassTierListButton.style.opacity = "0.5";
        ...
        setTimeout(() => {
            ...
            finalImage.onload = () => {
                ...
                subclassTierListButton.disabled = false;
            subclassTierListButton.style.opacity = "1";
            };
...
function renderSpells(spells, container = spellList) {
        ...
        spells.forEach(spell => {
            ...
            // --- LÓGICA DE CONCENTRACIÓN (DENTRO DEL BUCLE) ---
            const esConcentracion = spell.concentracion && spell.concentracion.toLowerCase() === "si";
            ...
            const isFav = (favoriteSpellsByCharacter[currentCharacter] || []).includes(spell.Nombre);
            ...
            spellCard.innerHTML = `
                ...
                <div class="spell-details ${detailsHiddenClass}">
                    <p class="spell-meta">
                        ...
                        ${esConcentracion ? ' <strong style="color: #ff7f7f;">(Concentración)</strong>' : ''}
                    </p>
                    <div class="spell-meta">
                        ...
                        <p><strong>Concentración:</strong> ${textoConcentracion}</p>
                    </div>
                    <p class="spell-meta">
