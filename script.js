    ...
    const classes = [
        ...
        { name: "Paladin", hitDie: 'd10', savingThrows: ['WIS', 'CHA'], image: "images/paladin.webp", description: "Caballero sagrado que combate el mal con el poder divino y un fuerte código de honor.", link: "https://homebrewery.naturalcrit.com/share/QL_7_qGcSaio", subclasses: ["Oath of the Ancients", "Oath of Avarice","Oath of Beauty", "Oath of the Blade", "Oath of the Bound", "Oath of Conquest", "Oath of the Corsair", "Oath of Cosmos","Oath of the Crown", "Oath of Devotion", "Oath of the Doomforged","Oath of the Eldritch Hunt","Oath of the Eternal Dragon", "Oath of Eternal Night", "Oath of the Exorcist", "Oath of the Forge", "Oath of Glory", "Oath of Heresy", "Oath of Inquisition", "Oath of Judgement","Oath of Liberty", "Oath of Neversetting Star","Oath of Mysticism", "Oath of Preservation", "Oath of Prosperity", "Oath of Redemption", "Oath of Revelry", "Oath of the Sanity", "Oath of the Shield", "Oath of Silence","Oath of Speed","Oath of Splendor","Oath of Solar","Oath of Storms", "Oath of the Sun", "Oath of Timekeeper","Oath of Vengeance", "Oath of the Watchers", "Oath of Winter", "Oath of the Yojimbo", "The Oathless", "Oathbreaker"] },
        { name: "Psionico", hitDie: 'd6', savingThrows: ['WIS', 'INT'], image: "images/psion.webp", description: "La realidad se desvía hacia donde van tus pensamientos. Los psiónicos canalizan la voluntad pura, transformando el pensamiento, la emoción y la memoria en fuerza psíquica pura.", link: "https://homebrewery.naturalcrit.com/share/MoGx_lZZ32mC", subclasses: ["Awakened Mind", "Consuming Mind", "Elemental Mind", "Knowing Mind","Resonant Mind","Shaper’s Mind", "Transcended Mind", "Unleashed Mind","Wandering Mind"] },
